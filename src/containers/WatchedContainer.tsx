...
import {
  useInfiniteRatedMovies,
  useInfiniteRatedTVShows,
...
export default function WatchedContainer() {
  ...
  const moviesQuery = useInfiniteRatedMovies()
  const tvShowsQuery = useInfiniteRatedTVShows()
