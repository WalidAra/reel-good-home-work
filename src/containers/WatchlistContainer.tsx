...
import {
  useInfiniteWatchlistMovies,
  useInfiniteWatchlistTVShows,
...
export default function WatchlistContainer() {
  ...
  const moviesQuery = useInfiniteWatchlistMovies()
  const tvShowsQuery = useInfiniteWatchlistTVShows()
